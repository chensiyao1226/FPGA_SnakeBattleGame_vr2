...
HD_PWD='C:/Users/ASUS/Desktop/PLD/battle/battle.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log VGA_ctler.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source VGA_ctler.tcl
