...
HD_PWD='C:/Users/ASUS/Desktop/PLD/battle/battle.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log VGA_ctler.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source VGA_ctler.tcl -notrace
